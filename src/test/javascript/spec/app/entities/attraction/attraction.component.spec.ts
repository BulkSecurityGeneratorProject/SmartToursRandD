...
import { AttractionComponent } from 'app/entities/attraction/attraction.component';
    ...
    describe('Attraction Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AttractionComponent, '')
                .compileComponents();
